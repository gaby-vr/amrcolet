    ...
    <div class="pt-16 bg-gray-100">
        <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
            <div class="w-full sm:max-w-7xl mt-6 p-6 bg-white shadow-md overflow-hidden sm:rounded-lg prose">
				...
				<p>
				    Cod unic de înregistrare: RO 44117011
				</p>
				<p>
				    Certificat de înregistrare: B4267262, emis pe data de 15.04.2021
				</p>
				<p>
				    Adresă sediu social: Targu-Mures, str.LIvezeni, nr.26, Judet Mures
				</p>
				<p>
				    Pagina web: <a href="http://www.amrcolet.ro/">www.amrcolet.ro</a>
				</p>
				<p>
				...
				<ol start="2" type="1">
				    ...
				    <li>
				        ...
				        <ul type="circle">
				            <li>
				                eliberarea de către furnizor expeditorului a unui document care
				                permite furnizorului identificarea internă a trimiterii în
				                reţeaua poştală şi care atestă data, ora şi minutul depunerii,
				                precum şi, de regulă, plata tarifului;
				            </li>
				            <li>
				                predarea trimiterii poştale la adresa destinatarului, personal
				                către acesta sau către persoana autorizată să primească
				                trimiterea poştală;
				            </li>
				            <li>
				            ...
				            <li>
				                răspunderea furnizorului pentru nerespectarea timpilor de
				                livrare;
				            </li>
				        </ul>
				    </li>
				    <li>
				        ...
				        prin intermediul rețelei poștale, a contravalorii bunului care face
				        obiectul trimiterii poştale înregistrate;
				    </li>
				    <li>
				        Serviciul confirmare de primire - serviciu poştal a cărui
				        particularitate constă în predarea către expeditor a dovezii privind
				        predarea trimiterii poştale înregistrate, confirmată în scris de către
				        destinatar;
				    </li>
				    <li>
				        Serviciul schimbare destinaţie - serviciu poştal având ca obiect
				        trimiteri poştale înregistrate, a cărui particularitate constă în
				        posibilitatea schimbării înainte de predarea trimiterii, la solicitarea
				        expresă a expeditorului comunicată furnizorului într-un termen convenit
				        în prealabil cu acesta, a destinatarului sau a adresei de livrare,
				        precum şi în posibilitatea opririi predării trimiterii poştale;
				    </li>
				    <li>
				        Serviciul livrare specială - serviciul poştal având ca obiect trimiteri
				        poştale înregistrate, a cărui particularitate constă în predarea
				        trimiterii poştale, personal destinatarului sau persoanei autorizate să
				        primească trimiterea poştală, potrivit indicaţiilor expeditorului
				        privind fie data şi ora predării, la adresa indicată, fie ordinea de
				        predare, în cazul mai multor destinatari;
				    </li>
				    <li>
				        Serviciul de trimitere cu valoare declarată - serviciul poștal a cărui
				        particularitate constă în asigurarea unei trimiteri poștale
				        înregistrate împotriva pierderii, furtului, distrugerii totale sau
				        parțiale ori deteriorării, pentru o sumă care nu poate depăși valoarea
				        declarată de către expeditor, și în eliberarea, la cerere, ulterior
				        depunerii, respectiv livrării trimiterii poștale, a unei dovezi privind
				        depunerea trimiterii poștale sau livrarea la destinatar, fără a fi
				    ...
				    <li>
				        ...
				        deteriorare a trimiterii poștale înregistrate și în eliberarea, la
				        cerere, ulterior depunerii, respectiv livrării trimiterii poștale, a
				        unei dovezi privind depunerea trimiterii poștale sau livrarea la
				        destinatar, fără a fi confirmată în scris de către acesta;
				    </li>
				    <li>
				        Serviciul de publicitate prin poștă - serviciul poştal având ca obiect
				        un număr de minimum 500 de trimiteri poștale interne sau internaționale
				        depuse la acelaşi punct de acces, în acelaşi timp, care urmează să fie
				        transportate și livrate la adresa indicată de expeditor pe trimiterea
				        în sine sau pe ambalajul acesteia, constând exclusiv în materiale de
				        reclamă, marketing sau publicitate, ce conțin mesaje identice, cu
				        excepția numelui, adresei și numărului de identificare a
				        destinatarului, precum și a altor modificări care nu alterează natura
				        mesajului. Nu constituie publicitate prin poștă:
				        <ul type="circle">
				            <li>
				                chitanțele, facturile, situațiile financiare și alte mesaje
				                având un conținut diferit;
				            </li>
				            <li>
				                trimiterile poștale care conțin, în afară de publicitate prin
				                poștă, și alte trimiteri în același ambalaj.
				            </li>
				        </ul>
				    </li>
				</ol>
				...
				<ol start="1" type="1">
				    ...
				    <li>
				        ...
				        comanda de a prelua și livra trimiterile poștale prin partenerii sai
				        autorizati ANCOM . Livrarea trimiterii poștale se va efectua prin
				        rețeaua poștală a partenerilor AMR COLET SRL . Fiecare trimitere
				        poștală se indentifică de către AMR COLET SRL în rețeaua poștală
				...
				<ol start="1" type="1">
				    ...
				    <li>
				        Servicii de publicitate prin posta avand ca obiect trimiteri postale si
				        internationale.
				    </li>
				    <li>
				        Servicii constând în colectarea, sortarea, transportul si livrarea
				...
				<p>
				    ...
				    conținutul trimiterilor poştale să fie suficient protejat față de o
				    manipulare mecanică în timpul procesului de sortare (înălțimea de cadere in
				    diagonala de la 80 cm). În plus, este obligatoriu să nu fie posibil accesul
				    la conținutul trimiterilor fără a lăsa urme.
				</p>
				<p>
				...
				<ol start="3" type="1">
				    ...
				    <li>
				        Zonele geografice în care furnizorul poate livra trimiterile poștale
				        prin mijloace proprii şi zonele geografice în care poate asigura
				        livrarea prin intermediul unui alt furnizor: întreg teritoriul României
				        și internațional, conform Ofertei comerciale;
				    </li>
				    <li>
				...
				<ol start="8" type="1">
				    <li>
				        ...
				        trimiterile poştale interne, EURO, LEVA, FORINTI SI ZLOTI pentru
				        trimiterile postale internationale colectate/livrate din Bulgaria,
				        Ungaria , Grecia, Polonia (sume maxime pentru incasare contra ramburs
				        la aceasta data : Ungaria - 500,000 HUF,Grecia – 500 EUR, Polonia-
				        15.000 PLN).
				    </li>
				</ol>
				<p>
				...
				<ol start="1" type="1">
				    ...
				    <li>
				        ...
				        livrare postala, tranzit sau destinatie;
				    </li>
				    <li>
				...
				<p>
				    B. AMR COLET SRL este imputernicită sa refuze livrarea daca, dupa
				...
				<p>
				    C. Acceptarea în vederea livrării a trimiterilor postale depuse închise,
				...
				<p>
				    D. In plus fata de orice raspundere constituita legal, clientul va raspunde
				    pentru orice paguba directa sau indirecta cauzată de bunurile care fac
				    obiectul trimiterilor postale, care sunt excluse de la acceptare
				    (colectare).
				</p>
				<p>
				...
				<ol start="1" type="1">
				    <li>
				        ...
				        <ol start="1" type="1">
				            <li>
				                Organizarea serviciului poştal de catre furnizor, de la
				                colectarea si până la livrarea trimiterilor poştale la
				                destinatar. AMR COLET SRL colecteaza si livreaza trimiterile
				                prin mijloace si personal aparţinând colaboratorilor, prin
				                intermediul punctelor de acces apartinand partenerilor;
				            </li>
				            <li>
				                Livrarea, cu scopul indeplinirii obligatiei, destinatarului sau
				                persoanei autorizate, la adresa indicată de expeditor, cu
				                exceptia cazurilor in care exista un motiv plauzibil de a pune
				                la indoiala dreptul acestei persoane de a prelua trimiterea
				                poştală (nu este obligatorie verificarea de către AMR COLET SRL
				                a identitatii acestei persoane, cu exceptia trimiterilor
				                postale recomandate, AMR COLET SRL asumându-şi răspunderea, în
				                consecinţă, cu privire la acest fapt). AMR COLET SRL oferă, de
				                asemenea, posibilitatea de a livra trimiterile poştale la un
				                sistem automat de livrare. AMR COLET SRL nu livrează trimiteri
				                poştale la cutia poştală.
				            </li>
				            <li>
				                Returul către client (expeditor) a oricaror trimiteri poştale
				                ce nu pot fi livrate sau sunt refuzate de destinatar;
				            </li>
				        </ol>
				    </li>
				</ol>
				<ol start="2" type="1">
				    <li>
				        Daca destinatarul nu este gasit, se va efectua o a doua incercare de
				        livrare, informând destinatarul cu privire la următoare încercare de
				        livrare;
				    </li>
				    <li>
				        ...
				        autorizata sa primeasca trimiterea postala nu este gasita la
				        destinatie, la ultima încercare de livrare, AMR COLET SRL va lasa un
				        aviz ce contine detalii despre: numarul documentului de transport, data
				        ...
				        acestuia prin mijloace electronice, excepţie făcând însă serviciile
				        poştale Express şi Livrare specială, în cazul cărora, după ultima
				        încercare de livrare, AMR COLET SRL va returna trimiterea poştală ce
				        face obiectul unuia dintre aceste servicii la expeditor/integrator. In
				        cazul in care destinatarul refuza coletul, returul se proceseaza
				        automat in aceeasi zi, fără parcurgerea procedurii de avizare a
				        destinatarului.
				    </li>
				</ol>
				<ol start="4" type="1">
				    <li>
				        Daca in urma celor doua incercari de livrare trimiterea postala nu va
				        fi predata destinatarului, aceasta va fi pastrata, fără a implica vreun
				        tarif, la punctul de contact deservit de personal al partenerilor, de
				        unde poate fi ridicată în decurs de 7 zile calendaristice de la data
				        avizarii, perioada in care se pot stabili cu expeditorul si/ sau
				        destinatarul, şi detaliile unei noi (ultimei) incercari de livrare,
				        fără a implica vreun tarif suplimentar;
				    </li>
				    <li>
				        In cazul in care trimiterea postala nu poate fi predata destinatarului
				        si nici returnata expeditorului aceasta va fi pastrata la sediul
				        partenerilor timp de 9 luni de la data preluarii, perioadă care nu va
				        implica plata unor tarife în vederea păstrării.
				    </li>
				    <li>
				        Numărul minim de trimiteri postale care pot face obiectul serviciului
				        poştal: minimum 1, cu exceptia serviciului de publicitate prin posta,
				        caz in care numarul minim este de 500 de trimiteri postale interne sau
				        internationale.
				    </li>
				    <li>
				...
				<ol start="1" type="1">
				    <li>
				        ...
				        <ul type="circle">
				            <li>
				                Cu excepţia serviciului express și livrare specială, timpii de
				                livrare garantaţi pentru serviciile poştale având ca obiect
				                trimiteri postale interne, sunt de 2 zile lucratoare. De
				                asemenea, prin derogare de la acest termen, în cazul
				                localitatile cu zile fixe de vizitare, astfel indicate în
				                oferta comercială a AMR COLET SRL, termenul de livrare a
				                trimiterilor poștale interne este de maxim 7 zile
				                calendaristice (acesta nefiind aplicabil în cazul serviciului
				                express și livrare specială).
				            </li>
				            <li>
				                Termenul de returnare a confirmarii de primire catre expeditor,
				                in cadrul serviciului poştal Confirmare de primire având ca
				                obiect trimiteri poştale interne, este de 2 zile lucratoare de
				                la momentul livrarii trimiterii poștale;
				            </li>
				            <li>
				                Returnarea contravalorii bunurilor care fac obiectul
				                serviciului contra ramburs având ca obiect trimiteri postale
				                interne se face in termen de maxim 7 zile lucratoare de la
				                livrarea trimiterii poştale;
				            </li>
				        </ul>
				    </li>
				</ol>
				    ...
				    <li>
				        ...
				        <ul type="circle">
				            <li>
				                ...
				                internaţionale, cu excepţia serviciului Express, timpii de
				                livrare garantati sunt de 10 zile lucratoare.
				            </li>
				            <li>
				                ...
				                internaţionale se face in termen de 7 zile lucratoare de la
				                livrarea trimiterii;
				            </li>
				            <li>
				                AMR COLET SRL nu presteaza serviciul confirmare de primire
				                având ca obiect trimiteri poştale internationale;
				            </li>
				        </ul>
				    </li>
				</ol>
				<ol start="3" type="1">
				    <li>
				        ...
				        <ul type="circle">
				            <li>
				                Timpii de livrare garantaţi pentru serviciul express încep de
				                la acceptarea trimiterii postale in vederea livrarii şi vor
				                respecta următoarele condiţii:
				                <ul type="square">
				                    <li>
				                        în cazul trimiterilor poştale interne, timpii de
				                        livrare nu vor depăşi 12 ore în aceeaşi localitate, 24
				                        de ore între reşedinţele de judeţ şi intra-judeţean,
				                        respectiv 36 de ore între oricare alte două localităţi.
				                    </li>
				                    <li>
				                        Timpii de livrare garantati pentru trimiteri postale
				                        internationale care fac obiectul serviciului express:
				                        <ul type="square">
				                            <li>
				                                în cazul trimiterilor poştale internaţionale,
				                                timpul cât trimiterea postala se află pe
				                                teritoriul României nu poate depăşi limitele
				                                prevăzute de prezentele conditii aferente
				                                trimiterilor poştale interne;
				                            </li>
				                            <li>
				                                în cazul trimiterilor poştale internaţionale
				                                colectate de pe teritoriul României şi care
				                                urmează a fi livrate unui destinatar aflat în
				                                unul dintre statele membre ale Uniunii Europene
				                                sau ale Spaţiului Economic European, timpul cât
				                                trimiterea postala se află în afara
				                                teritoriului României este de 120 de ore;
				                            </li>
				                            <li>
				                                în cazul trimiterilor poştale internaţionale
				                                colectate de pe teritoriul României şi care
				                                urmează a fi livrate pe teritoriul unui stat
				                                aflat in afara Uniunii Europene sau in afara
				                                Spaţiului Economic European, timpul cât
				                                trimiterea postala se află în afara
				                                teritoriului României este de maxim 168 de ore
				                                (estimativ 7 zile);
				                            </li>
				                        </ul>
				                    </li>
				...
				<ol start="4" type="1">
				    <li>
				        ...
				        intarziere a trimiterilor postale prin plata unor penalitati in cuantum
				        de 0,10% din tariful serviciului indiferent de intarziere, cu exceptia
				        serviciului express, in cazul caruia raspunde în acelaşi cuantum per 12
				        ore intarziere.
				    </li>
				    <li>
				...
				<p>
				    In cadrul reglementarilor AMR COLET SRL limita maximă admisă a valorii
				    declarate este de 13.000 euro/trimitere poştală (sau echivalent in RON), în
				    condiţiile de acceptare stabilite de AMR COLET SRL mai sus, iar suma
				    asigurata creste in multipli de EUR 500;
				</p>
				<p>
				    Notă: Prin excepţie, pentru sumele care depasesc 5000 euro (sau
				    echivalentul în lei), este posibila optarea pentru serviciul de trimitere
				    cu valoare declarata numai cu consultarea si confirmarea AMR COLET SRL
				    anterior introducerii trimiterii poștale în rețeaua poștală a AMR COLET
				    SRL, în condiţii contractuale exprese în acest sens;
				</p>
				<ol start="8" type="1">
				    <li>
				        Termenul în care poate fi solicitată de către expeditor dovada privind
				        ...
				        la data solicitării acesteia, conform modalitătii prevăzute în
				        contractul dintre părţi, în temeiul căruia se prestează serviciul.
				    </li>
				</ol>
				<p>
				...
				<ol start="1" type="1">
				    <li>
				        ...
				        <ul type="circle">
				            <li>
				                adresa destinatarului nu există sau la adresa indicată nu
				                există nicio construcţie ori un serviciu disponibil destinat
				                primirii trimiterii poștale;
				            </li>
				            <li>
				                destinatarul sau persoana autorizată să primească trimiterea
				                poştală nu a fost găsit(ă) la adresa indicată, după expirarea,
				                atunci când este cazul, a termenului de păstrare în vederea
				                predării;
				            </li>
				            <li>
				                destinatarul sau persoana autorizată să primească trimiterea
				                poştală a refuzat să primească, după caz, trimiterea poştală,
				                confirmarea în scris, conform prevederilor legale, a primirii
				                trimiterii poştale în cazul serviciului Confirmare de primire
				                ori achitarea contravalorii bunului care face obiectul
				                serviciului contra ramburs;
				            </li>
				        </ul>
				    </li>
				    <li>
				        Returnarea se va face la cel mai apropiat punct de acces al
				        partenerilor de adresa expeditorului, şi nu va implica, in sarcina
				        expeditorului, plata unor tarife în acest sens, expeditorul fiind, în
				        prealabil, informat in scris despre posibilitatea preluarii trimiterii
				        poştale de la respectivul punct de acces al partenerilor.
				    </li>
				    <li>
				...
				<ol start="1" type="1">
				    ...
				    <li>
				        ...
				        convenit, AMR COLET SRL poate aplica penalitati in cuantum de 0.15 %
				...
				<p>
				    XII. Deschiderea, returnarea, dispunerea si distrugerea de trimiteri
				    postale.
				</p>
				<ol start="1" type="1">
				    <li>
				...
				<ol start="1" type="1">
				    ...
				    <li>
				        ...
				        prima solicitare, acestea vor fi facturate expeditorului;
				    </li>
				    <li>
				        Clientul va despagubi AMR COLET SRL pentru toate costurile suportate de
				        AMR COLET SRL din momentul deschiderii si / sau dispunerii si/sau
				        distrugerii coletului conform Sectiunii XII.
				    </li>
				</ol>
				<p>
				    XIV. Raspunderea.
				...
				<ol start="1" type="1">
				    ...
				    <li>
				        1. AMR COLET SRL răspunde pentru trimiterile postale interne si
				        internationale, după cum urmează:
				        <ul type="circle">
				            <li>
				                în caz de pierdere, furt sau distrugere totală:
				                <ul type="square">
				                    <li>
				                        cu întreaga valoare declarată, pentru o trimitere
				                        poştală care face obiectul unui serviciu de trimitere
				                        cu valoare declarată, inclusiv dacă respectiva
				                        trimitere poştală face sau nu obiectul unui serviciu
				                        contra ramburs;
				                    </li>
				                    <li>
				                        cu valoarea rambursului, pentru o trimitere poştală
				                        care face obiectul unui serviciu contra ramburs fără
				                        valoare declarată;
				                    </li>
				                    <li>
				                        cu suma reprezentând de 5 ori tariful serviciului,
				                        pentru trimiterile poştale care nu fac obiectul unui
				                        serviciu de trimitere cu valoare declarată sau unui
				        ...
				        <li>
				            ...
				            <ul type="square">
				                <li>
				                    ...
				                    deteriorată ori cu cota-parte corespunzătoare greutății
				                    lipsă din valoarea declarată, pentru trimiterile poștale
				                    care fac obiectul unui serviciu de trimitere cu valoare
				                    declarată;
				                </li>
				                <li>
				                    cu suma reprezentând de 5 ori tariful serviciului, în caz
				                    de pierdere parțială, distrugere parțială sau deteriorare a
				    ...
				    <li>
				        ...
				        <ul type="circle">
				            <li>
				                ...
				                corespunzătoare până la valoarea integrală a acestuia, în cazul
				                în care contra rambursul a fost încasat parţial de la
				                destinatar;
				            </li>
				        </ul>
				    </li>
				...
				<p>
				    4. 2. La sumele prevăzute mai sus se adaugă dobânda legală penalizatoare
				...
				<p>
				    4.3. Pierderea completă a conținutului este echivalentă cu pierderea
				    trimiterii poștale;
				</p>
				<p>
				...
				<p>
				    4.4. În afara despăgubirilor prevăzute, se restituie și tarifele încasate,
				    în limita valorică a neîndeplinirii obligației asumate de către AMR COLET
				    SRL. Restituirea integrală a tarifelor încasate are loc doar în cazul
				    pierderii, furtului sau a distrugerii totale;
				</p>
				<p>
				    4.5. În cazul neefectuării prestațiilor care constituie caracteristici
				...
				<p>
				    4.6. În cazul pierderii dovezii privind predarea trimiterii poștale
				...
				<p>
				    4.7. Expeditorul poate renunța la dreptul sau de despăgubire în favoarea
				    destinatarului;
				</p>
				<ol start="5" type="1">
				    <li>
				        ...
				        <ul type="circle">
				            <li>
				                paguba s-a produs ca urmare a faptei expeditorului sau
				                destinatarului;
				            </li>
				            <li>
				                trimiterea a fost primită fără obiecţii de către destinatar, cu
				                excepţia reclamaţiilor referitoare la pierderea, furtul,
				                deteriorarea sau distrugerea totală ori parţială a conţinutului
				                trimiterii poştale;
				            </li>
				            <li>
				                paguba s-a produs ca urmare a unui caz de forţă majoră sau a
				                cazului fortuit; în acest caz, expeditorul are dreptul la
				                restituirea tarifelor achitate, cu excepţia tarifului de
				                asigurare.
				            </li>
				        </ul>
				    </li>
				...
				<ol start="1" type="1">
				    <li>
				        ...
				        <ul type="circle">
				            <li>
				                prin poștă, recomandabil cu confirmare de primire, la sediul
				                social al SC AMR COLET SRL;
				            </li>
				            <li>
				                scanată, pe e-mail, folosind următoarea adresă:
				                <a href="https://wordtohtml.net/office@amrcolet.ro">
				                    office@amrcolet.ro
				                </a>
				            </li>
				        </ul>
				...
				<ol start="3" type="1">
				    <li>
				        ...
				        <ul type="circle">
				            <li>
				                pierderea, furtul, distrugerea / deteriorarea totala sau
				                parțială a trimiterilor poștale;
				            </li>
				            <li>
				...
				<ol start="4" type="1">
				    ...
				    <li>
				        ...
				        <ul type="circle">
				            ...
				            <li>
				                Orice dovezi pe care reclamantul le consideră relevante şi pe
				                baza cărora își întemeiază pretențiile în vederea efectuării
				                unor analize corecte și complete şi a soluţionării reclamaţiei
				                (de exemplu, fotografii, descrierea bunurilor care fac obiectul
				                trimiterii poştale, bunul distrus/deteriorat care face obiectul
				                trimiterii poştale, ambalajul trimiterii poştale etc.);
				            </li>
				            <li>
				                Documente fiscale (copie bon fiscal, chitanta, ordin de plata
				                etc.) care atestă plata serviciului reclamat, atunci când plata
				                a fost efectuată de persoana reclamantă;
				            </li>
				            <li>
				                Proces verbal constatator încheiat în prezența reprezentantului
				                AMR COLET SRL sau a partenerilor – dacă este cazul;
				            </li>
				        </ul>
				    </li>
				    <li>
				        Expeditorul / destinatarul sau imputerniciții legali ai acestora vor
				        avea dreptul la despăgubiri, numai dacă reclamația a fost introdusă în
				        cadrul termenelor prevăzute mai sus;
				    </li>
				    <li>
				    ...
				    <li>
				        ...
				        <ul type="circle">
				            <li>
				                ...
				                <ul type="square">
				                    <li>
				                        Persoana juridica emite o factură către AMR COLET SRL;
				                    </li>
				                    <li>
				                        Se specifică pe factură “despăgubire, conform Nota de
				                        transport/AWB nr. _____ din data de _____ , pentru
				                        neprestarea serviciului sau daună produsă în timpul
				                        prestării serviciului poștal”;
				                    </li>
				                    <li>
				                        La sumele cuprinse pe factură nu se aplică TVA;
				                    </li>
				                    <li>
				                        În cazul în care reclamaţia clientului este intemeiată,
				                        fiind soluţionată favorabil, acesta va fi informat în
				                        acest sens și va trebui să emită și să transmită către
				                        AMR COLET SRL o factură în temeiul căreia să îi fie
				                        plătită despăgubirea.
				                    </li>
				                </ul>
				            </li>
				        </ul>
				...
				<ol start="3" type="1">
				    ...
				    <li>
				        ...
				        trimiteri poștale au fost deteriorate din această cauză. În toate
				        cazurile, termenul pentru înaintarea plângerii către ANCOM sau pentru
				        introducerea cererii de chemare în judecată este de 1 an. Termenul de
				        prescripție prevăzut curge de la data depunerii trimiterii poștale.
				    </li>
				</ol>
				<p>
