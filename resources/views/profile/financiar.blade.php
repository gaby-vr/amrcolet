<x-jet-table>
    <div class="row col-span-12">
        ...
        <form action="{{ route('dashboard.financiar.show') }}" method="get">
    ...
    <x-slot name="thead">
        ...
        <x-jet-tr location='thead'>
            ...
            <x-jet-td location='thead'>{{ __('Denumire') }}</x-jet-td>
            <x-jet-td location='thead'>{{ __('Total') }}</x-jet-td>
            <x-jet-td location='thead'>{{ __('PLatit La') }}</x-jet-td>
    ...
    <x-jet-tr>
        ...
        <x-jet-td>{{ Carbon\Carbon::parse($invoice->payed_on)->format('d/m/Y') }}</x-jet-td>
        <x-jet-td class="sm:text-center">
            ...
            @elseif($invoice->status == 3)
                <span class="chip blue lighten-5 m-0">
                    <span class="blue-text">{{ __('Stornata') }}</span>
                </span>
