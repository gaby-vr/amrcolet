...
<div class="input-field col l12 m6 s12 mb-1 mt-0" style="margin-top: 0;">
    <div class="card m-0" style="margin: 0;">
        <div class="card-content pt-1 pb-1 m-0" style="margin: 0; padding-top: 0.25rem; padding-bottom: 0.25rem;">
            <div class="row flex service" style="margin-bottom: 0;">
                <div class="input-field col l1 m12 s12 items-center flex p-0 justify-center fit-square" style="min-width: 105px; max-width: 250px; margin-right: auto;">
                    <img class="inline-block w-full" style="" src="{{ asset('img/curieri/'.$curier->logo ) }}">
                </div>
                <div class="input-field col l1 m12 s12 text-center p-0 relative flex items-center justify-center" style="min-width: 147px;">
                    ...
                    <p class="relative w-full">
                        @if($discounts[$curier->id])
                            <span class="absolute font-weight-700 text-red-500 w-full" style="top: -20px; left: 0; right: 0;">Promotie -{{ $discounts[$curier->id] }}%</span>
                        @endif
                        <b>{{ $curier->name }}</b>
                    </p>
                </div>
                @if($discounts[$curier->id])
                <div class="input-field col l1 s12 row relative" style="min-width: 220px;">
                    <div class="input-field col s5 m4 text-right p-0 pr-1 relative" style="min-width: 60px; padding-left: 0;">
                    ...
                    <div class="input-field col s7 m8 text-left p-0 relative" style="min-width: 115px; padding: 0;">
                ...
                @else
                <div class="input-field col l1 m12 s12 p-0 relative text-center lg:text-left flex justify-center" style="min-width: 220px;">
                    <div style="min-width: 130px;">
                        <p class="text-green-500 relative" style="top:-5px;">{{ round(($prices[$curier->id] * 100)/(100 + $curier->tva), 2) }} ron + tva</p>
                        <p class="text-green-500 relative" style="font-size: 1.8rem; bottom: 12px;">{{ round($prices[$curier->id], 2) }} ron</p>
                    </div>
                </div>
                @endif
                <div class="input-field col l2 m12 s12 text-center flex justify-center">
                    <div class="flex justify-between" style="min-width: 135px; max-width: 250px;">
                ...
                {{-- <div class="input-field col l2 m12 s12 p-0 text-center lg:text-left" style="min-width: 200px;">
                	<div class="col s1 p-0 {{ $curier->work_saturday ? '' : 'opacity-30' }}" style="min-width: 30px;">
                    	<span class="fa-layers fa-fw fa-lg">
						    <i class="far fa-calendar"></i>
						    <span class="fa-layers-text" data-fa-transform="shrink-11 down-2" style="font-weight:900">SAT</span>
						</span>
					</div>
					<div class="col s1 p-0 {{ $curier->require_awb ? '' : 'opacity-30' }}" style="min-width: 30px;">
                		<i class="fas fa-print fa-lg"></i>
                	</div>
                	<div class="col s1 p-0 {{ $curier->ramburs_cash ? '' : 'opacity-30' }}" style="min-width: 30px;">
                		<i class="fas fa-money-bill-wave fa-lg"></i>
                	</div>
                	<div class="col s1 p-0 {{ $curier->ramburs_cont ? '' : 'opacity-30' }}" style="min-width: 30px;">
                		<i class="far fa-credit-card fa-lg"></i>
                	</div>
                	<div class="col s1 p-0 {{ $curier->assurance ? '' : 'opacity-30' }}" style="min-width: 30px;">
                		<i class="fas fa-file-invoice fa-lg"></i>
                	</div>
                	<div class="col s1 p-0 {{ $curier->open_when_received ? '' : 'opacity-30' }}" style="min-width: 30px;">
                    	<span class="fa-layers fa-fw fa-lg">
						    <i class="far fa-eye" data-fa-transform="shrink-8 up-4"></i>
						    <i class="fas fa-box-open" data-fa-transform="shrink-5 down-5"></i>
						</span>
					</div>
					<div class="col s1 p-0" style="min-width: 50px;">
						<span class="fa-layers fa-fw fa-lg mr-9">
